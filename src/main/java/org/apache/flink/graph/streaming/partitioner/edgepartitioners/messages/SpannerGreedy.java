...
public class SpannerGreedy {
	...
	public static void main(String[] args) throws Exception {
		...
		GraphStream<Long, NullValue, NullValue> graph = new SimpleEdgeStream<>(edges.partitionCustom(new GreedyPartitioner<>(new CustomKeySelector(0),k), new CustomKeySelector<>(0)),env);
