...
public class THash {
	...
	public static void main(String[] args) throws Exception {
		...
		SimpleEdgeStream<Integer, NullValue> graph = new SimpleEdgeStream<>(edges.partitionCustom(new HashPartitioner<>(new CustomKeySelector(0)), new CustomKeySelector<>(0)),env);
