...
public class TGrid {
	...
	public static void main(String[] args) throws Exception {
		...
		SimpleEdgeStream<Integer, NullValue> graph = new SimpleEdgeStream<>(edges.partitionCustom(new GridPartitioner<>(new CustomKeySelector(0),k), new CustomKeySelector<>(0)),env);
