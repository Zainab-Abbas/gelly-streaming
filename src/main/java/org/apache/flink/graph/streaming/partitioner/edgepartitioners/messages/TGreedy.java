...
import org.apache.flink.graph.streaming.partitioner.tests.DumSink4;
...
public class TGreedy {
	...
	public static void main(String[] args) throws Exception {
		...
		SimpleEdgeStream<Integer, NullValue> graph = new SimpleEdgeStream<>(edges.partitionCustom(new GreedyPartitioner<>(new CustomKeySelector(0),k), new CustomKeySelector<>(0)),env);
		...
		graph.buildNeighborhood(false)
				...
				.keyBy(0).flatMap(new SumAndEmitCounters()).addSink(new DumSink4());
