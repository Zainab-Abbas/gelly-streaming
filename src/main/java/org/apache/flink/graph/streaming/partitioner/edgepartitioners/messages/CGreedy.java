...
import org.apache.flink.graph.streaming.partitioner.tests.DumSink2;
...
public class CGreedy {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<Edge<Long, NullValue>> partitionesedges = edges.partitionCustom(new GreedyPartitioner<>(new CustomKeySelector(0),k), new CustomKeySelector<>(0));
		...
		//	fw.write("The job took " + result.getNetRuntime(TimeUnit.NANOSECONDS) + " nanoseconds to execute" + "\n");
			fw.write("The job 1 took " + result.getNetRuntime(TimeUnit.SECONDS) + " seconds to execute" + "\n");//appends the string to the file
			fw.write("The job 1 took " + result.getNetRuntime(TimeUnit.NANOSECONDS) + " nanoseconds to execute" + "\n");
			fw.close();
